...
This document captures everything you need to know about Lovable.dev's capabilities and constraints before writing PRD documents or executing a build. Read this first — it shapes every decision in all other documents.

---

## The AI Memory Problem (Why Documentation Matters)

Lovable is a powerful AI coding agent — but it has no persistent memory. **Every session starts from scratch.** Without documentation, this creates a painful cycle:

| Without Documentation | With PRDs & Memory Layer |
|-----------------------|--------------------------|
| AI forgets your vision after a few prompts | AI references your docs before every action |
| Each session starts from scratch | Consistent vision across all sessions |
| Features drift from original intent | Features align with documented specs |
| Endless back-and-forth corrections | Less prompting, more building |

The solution is a **Documentation-First approach**: your PRD documents and `tasks.md` become the AI's long-term memory. Lovable reads your Knowledge Base before every response — so well-structured docs mean Lovable understands your architecture, design language, and scope boundaries from the very first prompt.

Your three sources of truth:
- **`masterplan.md`** — Your project vision & requirements
- **PRD files** — Feature specifications and architecture
- **`tasks.md`** — Source of truth for progress
...
Lovable gives you four distinct modes. Choose the right tool for each task — they aren't interchangeable.

### 1. Agent Mode (Default — Start Here)
The default mode. Describe what you want and the AI builds it autonomously.

**Best for:**
- Autonomous building of full features
- Multi-step tasks
- Auto-debugging
- Default mode for all new builds

**Tip:** Use Agent Mode for building, then switch to Visual Edits for polish.

### 2. Visual Edits
Click any element on the page to change text, colours, and fonts directly — no prompts needed.

**Best for:**
- Direct text editing
- Colour and font adjustments
- Fast adjustments (1 edit per message)
- Quick polish

### 3. Chat Mode
Conversational back-and-forth for iterative refinement.
...
### 4. Code Mode
Direct access to the codebase for precise technical control.

**Best for:**
- Full codebase access
- Git integration
- TypeScript/React experts
- For developers

**Pro Tip:** Start with Agent Mode for building. Use Visual Edits for quick polish.
...
7. **The documentation instruction** — Tell Lovable to always read your /docs folder
...
The more context you give Lovable about your visual system, the better:
- Add your brand guidelines, component screenshots, or style documentation directly to your prompt
- Lovable will follow attached design references more precisely than descriptions
- "Follow all attached brand guidelines. Prioritise functionality over visual style — we'll refine later."
...
docs/                   # Your documentation (masterplan, tasks, changelog, rules)
```

Reference this structure in your PRD so component placement is unambiguous. Store all documentation in the `/docs` folder so Lovable can reference it via the Knowledge Base instruction.
